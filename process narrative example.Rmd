...
cat("_This template provides a general process narrative framework. Use or discard sections as needed. Only mock data are used.\nNotes to user are presented in these chunks in italics._")
```

## Purpose
```{r, echo=FALSE, results='asis'}
cat("_What is the goal? This section describes the general aims of the task._")
```
...
## Background
```{r, echo=FALSE, results='asis'}
cat("_Why is this done? This section describes the history or broader context of the task._")
```
...
## Scope
```{r, echo=FALSE, results='asis'}
cat("_What does this affect? Who should do it? This section describes which individuals or units are involved, and where it may fit into broader processes if not self-contained._")
```
...
### Timeline
```{r, echo=FALSE, results='asis'}
cat("_When should this occur? This section describes timelines, due dates, or durations in short._")
```
...
### Definitions
```{r, echo=FALSE, results='asis'}
cat("_What is the meaning of terms used? This section describes terminology and dataset variables as needed._")
```
...
## Process
```{r, echo=FALSE, results='asis'}
cat("_What does this task consist of?_")
```
...
## Resources
```{r, echo=FALSE, results='asis'}
cat("_What resources, definitions, would help here?_")
```
